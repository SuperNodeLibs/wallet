<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"/home/www/snb_wallet/public/../application/index/view/member/Index.html";i:1511596070;s:65:"/home/www/snb_wallet/public/../application/index/view/layout.html";i:1511596070;s:72:"/home/www/snb_wallet/public/../application/index/view/public/header.html";i:1511850525;s:72:"/home/www/snb_wallet/public/../application/index/view/public/footer.html";i:1511596070;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
				...
				<div class="col-md-12">
					<div class="col-md-12">
						<div class="row membertopbox">
							<h5><?php echo \think\Lang::get('MEMBER_BASE_INFO'); ?></h5>
							<div class="col-md-10 nopadding" style="margin: 10px 0;">
								<div class="col-md-6">
									<label><?php echo \think\Lang::get('MEMBER_BASE_USERNAME'); ?>:</label>
									<?php echo \think\Session::get('USER_NAME'); ?>
								</div>
								<div class="col-md-6">
									<label><?php echo \think\Lang::get('MEMBER_BASE_EMAIL'); ?>:</label>
									<?php echo \think\Session::get('USER_EMAIL'); ?>
								</div>
								<div class="col-md-12">
									<label><?php echo \think\Lang::get('MEMBER_BASE_ACCOUNT'); ?>:</label>
									<?php echo \think\Session::get('USER_ACCOUNT'); ?>
								</div>
								<div class="col-md-12">
									<label><?php echo \think\Lang::get('MEMBER_BASE_SEC'); ?>:</label>
									<div class="input-group">
										<input type="text" id="clearSec" class="form-control" placeholder="<?php echo \think\Lang::get('MAIN_INPUT_PASSWORD'); ?>">
										<span class="input-group-btn">
											<button type="button" class="btn btn-primary" id="btn_getsec"><?php echo \think\Lang::get('MEMBER_BASE_GET'); ?></button>
										</span>
									</div>
									<p class="text-danger">*<?php echo \think\Lang::get('MEMBER_BASE_SEC_DESC'); ?></p>
								</div>
							</div>
							<div class="col-md-2 member_ewmbox">
								<img src="/qrcode.php?s=<?php echo \think\Session::get('USER_ACCOUNT'); ?>">
								<a href="/qrcode.php?s=<?php echo \think\Session::get('USER_ACCOUNT'); ?>" target="_blank"><?php echo \think\Lang::get('MEMBER_DOWNLOWD_QRCODE'); ?></a>
							</div>
						</div>
					</div>
    			</div>
    				...
    				<div class="col-md-6 member_repas">
    					<form>
	    					<div class="form-group">
	    						<label><?php echo \think\Lang::get('MEMBER_OLD_LOGIN_PASSWORD'); ?></label>
	    						<input type="password" class="form-control" name="old_password" id="old_password" required="required">
	    					</div>
	    					<div class="form-group">
	    						<label><?php echo \think\Lang::get('MEMBER_NEW_LOGIN_PASSWORD'); ?></label>
	    						<input type="password" class="form-control" name="password" id="password" required="required">
	    					</div>
	    					<div class="form-group">
	    						<label><?php echo \think\Lang::get('MEMBER_REL_LOGIN_PASSWORD'); ?></label>
	    						<input type="password" class="form-control" name="relog_pass" id="relog_pass" required="required">
	    					</div>
	    					<div class="form-group">
	    						<button class="btn btn-primary pull-right" type="button" id="changLogin" ><?php echo \think\Lang::get('MEMBER_MODIFY_LOGIN_PASSWORD'); ?></button>
	    					</div>
    					</form>
    				</div>
    				<div class="col-md-6 member_repas" >
    					<form>
	    					<div class="form-group">
	    						<label><?php echo \think\Lang::get('MEMBER_OLD_PAY_PASSWORD'); ?></label>
	    						<input type="password" class="form-control" name="old_paypass" id="old_paypass" required="required">
	    					</div>
	    					<div class="form-group">
	    						<label><?php echo \think\Lang::get('MEMBER_NEW_PAY_PASSWORD'); ?></label>
	    					...
	    					<div class="form-group">
	    						<button class="btn btn-primary pull-right" type="button" id="changPay"><?php echo \think\Lang::get('MEMBER_MODIFY_PAY_PASSWORD'); ?></button>
	    					</div>
    					</form>
    				</div>
    			</div>
...
<script>
	var p = "<?php echo \think\Session::get('USER_3DES'); ?>";
