<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"/home/www/snb_wallet/public/../application/user/view/user/Create.html";i:1511596070;s:64:"/home/www/snb_wallet/public/../application/user/view/layout.html";i:1511596070;s:71:"/home/www/snb_wallet/public/../application/user/view/public/header.html";i:1511850525;s:71:"/home/www/snb_wallet/public/../application/user/view/public/footer.html";i:1511596070;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<section class="container-fluid">
		<div class="container">
			<div class="col-md-5 login_box">
				...
				<h3 class="login_tit"><span class="glyphicon glyphicon-log-in"></span><?php echo \think\Lang::get('LOGIN_CREATETRUST_ACTIVE'); ?></h3>
				<div class="form-group"><i class="login_tips"><?php echo \think\Lang::get('LOGIN_CREATETRUST_TIP'); ?></span></i></div>
				...
				<div class="form-group">
					<button type="button" id="pay_btn2" class="btn btn-primary login_btn" ><?php echo \think\Lang::get('LOGIN_PAYSET_SUBMIT'); ?></button>
					<button type="button" id="pay_btn3" class="btn btn-primary login_btn" ><?php echo \think\Lang::get('LOGIN_CREATETRUST_ENTER'); ?></button>
					<a href="/logout" class="loginout"><?php echo \think\Lang::get('LOGIN_CREATETRUST_LOGOUT'); ?></a>
				</div>
				</form>
			</div>
		</div>
...
<script>
	...
	$("#pay_btn2").click(function() {
		...
		var des3='<?php echo \think\Session::get('USER_3DES'); ?>';
		var addr='<?php echo \think\Session::get('USER_ACCOUNT'); ?>';
		try{
	...
	function checkaccount(){
		if(isExistUser('<?php echo \think\Session::get('USER_ACCOUNT'); ?>')){
			location.href='/';
