<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"/home/www/snb_wallet/public/../application/index/view/address/Index.html";i:1511596070;s:65:"/home/www/snb_wallet/public/../application/index/view/layout.html";i:1511596070;s:72:"/home/www/snb_wallet/public/../application/index/view/public/header.html";i:1511850525;s:72:"/home/www/snb_wallet/public/../application/index/view/public/footer.html";i:1511596070;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<section class="container-fluid">
 ...
 <div class="col-md-10 wallet_min">
				<div class="col-md-12">
					<h4><?php echo \think\Lang::get('INDEX_ADDRESS_TITLE'); ?></h4>
					<table class="table table-bordered text-center">
						<tr>
							<td><?php echo \think\Lang::get('INDEX_ADDRESS_NAME'); ?></td>
							<td><?php echo \think\Lang::get('INDEX_ADDRESS_ADDRESS'); ?></td>
							<td><?php echo \think\Lang::get('INDEX_ADDRESS_OPTION'); ?></td>
						</tr>
						<?php if(is_array($address) || $address instanceof \think\Collection || $address instanceof \think\Paginator): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$add): $mod = ($i % 2 );++$i;?>
							<tr>
								<td><?php echo $add['address_name']; ?></td>
								<td><a href="/transaction?payment=<?php echo $add['address_account']; ?>"><?php echo $add['address_account']; ?></a></td>
								<td><a href="#" onclick="javascript:editAddress('<?php echo $add['address_id']; ?>', '<?php echo $add['address_name']; ?>','<?php echo $add['address_account']; ?>')" class="btn btn-primary"><?php echo \think\Lang::get('INDEX_ADDRESS_MODIFY'); ?></a><button type="button" class="btn btn-default" onclick="javascript:delAddress('<?php echo $add['address_id']; ?>')" ><?php echo \think\Lang::get('INDEX_ADDRESS_DELETE'); ?></button></td>
							</tr>
    			...
    			<div class="col-md-12">
    				<form name="address" id="address" method="post">
	    				...
	    				<h4><?php echo \think\Lang::get('INDEX_ADDRESS_ADDMODIFY_CONTACT'); ?></h4>
	    				<div class="col-md-3 nopadding">
	    					<div class="form-group lr_mode_group">
	    						<label><?php echo \think\Lang::get('INDEX_ADDRESS_NAME'); ?></label>
	    						<span class="r_control">
	    							<input type="text" class="form-control" name="address_name" id="address_name" datatype="*30" nullmsg="<?php echo \think\Lang::get('INDEX_ADDRESS_NAME_INPUT'); ?>" errormsg="<?php echo \think\Lang::get('INDEX_ADDRESS_NAME_RULE'); ?>" />
	    						</span>
	    					</div>
	    				</div>
	    				<div class="col-md-9">
	    					<div class="form-group lr_mode_group">
	    						<label class="text-right"><?php echo \think\Lang::get('INDEX_ADDRESS_ADDRESS'); ?>： </label>
	    						<span class="r_control" style="vertical-align: middle;">
	    							<div class="input-group">
	    								<input type="text" class="form-control" name="address_account" id="address_account" datatype="*56" nullmsg="<?php echo \think\Lang::get('INDEX_ADDRESS_ADDRESS_INPUT'); ?>" errormsg="<?php echo \think\Lang::get('INDEX_ADDRESS_ADDRESS_RULE'); ?>" placeholder="<?php echo \think\Lang::get('INDEX_ADDRESS_ADDRESS_INPUT_RULE'); ?>"/>
	    								<span class="input-group-btn">
	    								<button type="submit" class="btn btn-success"><?php echo \think\Lang::get('INDEX_ADDRESS_SAVE'); ?></button>
	    								</span>
	    							</div>
	    						</span>
	    					</div>
