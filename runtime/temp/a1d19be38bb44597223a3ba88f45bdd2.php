<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/home/www/snb_wallet/public/../application/user/view/user/Verifypass.html";i:1511596070;s:64:"/home/www/snb_wallet/public/../application/user/view/layout.html";i:1511596070;s:71:"/home/www/snb_wallet/public/../application/user/view/public/header.html";i:1511850525;s:71:"/home/www/snb_wallet/public/../application/user/view/public/footer.html";i:1511596070;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<section class="container-fluid">
		<div class="container">
			<div class="col-md-5 login_box">
				<form id="loginform">
				<h3 class="login_tit"><span class="glyphicon glyphicon-log-in"></span> <?php echo \think\Lang::get('LOGIN_RESET_SENDOK'); ?>！</h3>
				<div class="form-group">
					<i class="login_tips"><?php echo $email; ?> <?php echo \think\Lang::get('LOGIN_IS_YOUR_EMAIL'); ?>, <a href="http://mail.<?php echo $domain; ?>" class="blue-a1" target="_blank" ><?php echo \think\Lang::get('LOGIN_RESET_TOMAIL'); ?></a></i>
				</div>
				<div class="form-group">
					<i><?php echo \think\Lang::get('LOGIN_RESET_DESC'); ?></i>
				</div>
