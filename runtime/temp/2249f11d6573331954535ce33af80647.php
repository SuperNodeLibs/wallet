<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/home/www/snb_wallet/public/../application/user/view/user/Login.html";i:1511596070;s:64:"/home/www/snb_wallet/public/../application/user/view/layout.html";i:1511596070;s:71:"/home/www/snb_wallet/public/../application/user/view/public/header.html";i:1511850525;s:71:"/home/www/snb_wallet/public/../application/user/view/public/footer.html";i:1511596070;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<section class="container-fluid">
		<div class="container" >
			<div class="col-md-5 login_box">
				...
				<h3 class="login_tit"><span class="glyphicon glyphicon-log-in"></span> <?php echo \think\Lang::get('LOGIN_TITLE'); ?></h3>
				<div class="form-group">
					<label><?php echo \think\Lang::get('LOGIN_USER'); ?> : </label>
					<input type="email" placeholder="<?php echo \think\Lang::get('LOGIN_USER_HINT'); ?>" class="form-control" name="email" required>
				</div>
				<div class="form-group">
					<label><?php echo \think\Lang::get('LOGIN_PASS'); ?> : </label>
					<input type="password" placeholder="<?php echo \think\Lang::get('LOGIN_PASS_HINT'); ?>" class="form-control" name="password" required>
				</div>
				<div class="form-group">
					<button type="submit" class="btn btn-primary login_btn"><?php echo \think\Lang::get('LOGIN_ACTION'); ?></button>
				</div>
				<div class="form-group loginctl_box" style="color:red">
					<?php echo $error_msg; ?>
				</div>
				<div class="form-group text-right loginctl_box">
					<a href="/register"><?php echo \think\Lang::get('LOGIN_REGISTER'); ?></a>
					<a href="/forgetpassword"><?php echo \think\Lang::get('LOGIN_FORGETPASSWORD'); ?></a>
				</div>
				</form>
			</div>
		</div>
		<!--<div style="font-size: 30px; text-align: center;margin: 17% 0;">系统维护升级中，暂无法使用!</div>-->
	</section>
<!--Content end-->
